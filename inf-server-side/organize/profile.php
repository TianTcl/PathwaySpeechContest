<?php
	...
	$user = $rmte ? strval(intval($tcl -> decode(str_replace("-", "", $_GET['remote'])."5d3"))/138-138) : $_SESSION['evt2']['user'];
	if (isset($_POST['name']) && !empty(trim($_POST['name']))) {
		...
		if ($rmte) header("Location: $back#".(isset($notify)?"msg=app.ui.notify(1,[$notify])".(isset($notify)?"&msg2=app.ui.notify(1,[$notify2])":""):""));
