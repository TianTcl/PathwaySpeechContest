<?php
	...
	if (!(isset($_SESSION['evt2']) && $_SESSION['evt2']['EventID']==2)) header("Location: ../organize/?return_url=..%2Fresource%2Fb8f25895-502f-477a-aaf3-138d8540b270");
	else if ($_SESSION['evt2']["force_pwd_change"]) header("Location: ../organize/new-password?return_url=..%2Fresource%2Fb8f25895-502f-477a-aaf3-138d8540b270");
			...
			function gradefx() {
				...
				var initiate = function() {
					if (!sv.inited) {
						sv.inited = true;
						// Fetch list
						$.get(cv.APIurl+"?app=grade&cmd=list&attr=special-S2", function(res, hsc) {
