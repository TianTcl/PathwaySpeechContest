<?php
    ...
    if (isset($_REQUEST['of']) && !empty(trim($_REQUEST['of']))) {
        ...
        $getscore = $db -> query("SELECT CAST(a.p11 AS VARCHAR(5)) AS p11,CAST(a.p12 AS VARCHAR(5)) AS p12,CAST(a.p13 AS VARCHAR(5)) AS p13,CAST(a.p14 AS VARCHAR(5)) AS p14,CAST(a.p21 AS VARCHAR(5)) AS p21,CAST(a.p22 AS VARCHAR(5)) AS p22,CAST(a.p23 AS VARCHAR(5)) AS p23,CAST(a.p24 AS VARCHAR(5)) AS p24,CAST(a.p31 AS VARCHAR(5)) AS p31,CAST(a.p32 AS VARCHAR(5)) AS p32,CAST(a.p41 AS VARCHAR(5)) AS p41,CAST(a.mark AS VARCHAR(5)) AS mark,a.comment,substring(b.display, 4, LENGTH(b.display)) as judge FROM PathwaySCon_score2 a INNER JOIN PathwaySCon_organizer b ON a.judge=b.user_id WHERE a.smid=$smID UNION ALL SELECT CAST(AVG(p11) AS VARCHAR(5)) AS p11,CAST(AVG(p12) AS VARCHAR(5)) AS p12,CAST(AVG(p13) AS VARCHAR(5)) AS p13,CAST(AVG(p14) AS VARCHAR(5)) AS p14,CAST(AVG(p21) AS VARCHAR(5)) AS p21,CAST(AVG(p22) AS VARCHAR(5)) AS p22,CAST(AVG(p23) AS VARCHAR(5)) AS p23,CAST(AVG(p24) AS VARCHAR(5)) AS p24,CAST(AVG(p31) AS VARCHAR(5)) AS p31,CAST(AVG(p32) AS VARCHAR(5)) AS p32,CAST(AVG(p41) AS VARCHAR(5)) AS p41,CAST(AVG(mark) AS VARCHAR(5)) AS mark,'' AS comment,'Average' as judge FROM PathwaySCon_score2 WHERE smid=$smID GROUP BY smid");
        $db -> close();
...
<div class="table"><table><thead><tr>
    ...
    <th onClick="ro(2)"><span>1.1) Organization</span></th>
    <th onClick="ro(3)"><span>1.2) Accuracy</span></th>
    <th onClick="ro(4)"><span>1.3) Vocabulary</span></th>
    <th onClick="ro(5)"><span>1.4) Creativity</span></th>
    ...
    <th onClick="ro(12)"><span>4.1) Duration</span></th>
