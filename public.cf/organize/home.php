	...
	<body>
		...
		<main shrink="<?php echo($_COOKIE['sui_open-nt'])??"false"; ?>">
			<div class="container">
				...
				<input name="contest" type="checkbox" id="ref_menu-a"><label for="ref_menu-a"><?=$_COOKIE['set_lang']=="th"?"เกี่ยวกับ":"About"?></label><ul>
				...
				<input name="donate" type="checkbox" id="ref_menu-b"><label for="ref_menu-b"><?=$_COOKIE['set_lang']=="th"?"การบริจาค":"Donate"?></label><ul>
					...
					<li class="dl">&nbsp;</li>
					<li disabled><a href="donation"><?=$_COOKIE['set_lang']=="th"?"รายการที่รับบริจาค":"Donation list"?></a></li>
				</ul>
				<input name="stats" type="checkbox" id="ref_menu-c"><label for="ref_menu-c"><?=$_COOKIE['set_lang']=="th"?"สถิติต่างๆ":"Statics"?></label><ul>
