...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->InFooter = false;
		$this->lasth = 0;
		$this->FontFamily = defined('PDF_FONT_NAME_MAIN')?PDF_FONT_NAME_MAIN:'thsarabun';
		$this->FontStyle = '';
		$this->FontSizePt = 12;
		...
		$this->CoreFonts = array(
			...
			'thsarabun'=>'thsarabun',
			'thsarabunB'=>'thsarabun-Bold',
			'thsarabunI'=>'thsarabun-Oblique',
			'thsarabunBI'=>'thsarabun-BoldOblique',
			'times'=>'Times-Roman',
			'timesB'=>'Times-Bold',
			'timesI'=>'Times-Italic',
	...
	public function Close() {
		...
		if ($this->tcpdflink) {
			...
			$font = defined('PDF_FONT_NAME_MAIN')?PDF_FONT_NAME_MAIN:'thsarabun';
			$this->SetFont($font, '', 1);
	...
	protected function _putcatalog() {
		...
		if (!empty($this->form_obj_id)
			...
			$font = $this->getFontBuffer('thsarabun');
