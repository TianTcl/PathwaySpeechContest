<?php
	...
	switch ($_SESSION['event']['workshop-VDO']) {
		case 1:
			...
			$player_duration = ""; $player_thumbnail = "https://inf.bodin.ac.th/e/Pathway-Speech-Contest/resource/images/workshop-1.png"; break;
		default: header("location /e/Pathway-Speech-Contest/workshop/"); break;
